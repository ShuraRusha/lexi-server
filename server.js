...
app.post("/api/parse", async (req, res) => {
  try {
    ...
    const systemPrompt =
      ...
      "Определи язык текста, выдели до 50 наиболее полезных для изучения слов и устойчивых выражений " +
      "(исключи служебные слова: артикли, предлоги, местоимения, союзы). " +
      "Для каждой единицы верни: исходное слово/фразу (поле w), код её языка ISO 639-1 (поле lang), " +
